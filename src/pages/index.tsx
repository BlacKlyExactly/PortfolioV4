    ...
    <Wrapper>
      ...
      <LandingWrapper ref={landing}>
        ...
        <LandingBackground ref={image}>
          <Image fluid={background} style={{ height: "100vh" }} />
      ...
      <Template ref={works} background="#FBF5F5" center>
        <ShowUp
          ref={worksGrid}
          stagger={0.2}
          value={1000}
          ...
          <LatestWorksWrapper ref={worksGrid}>
            <LatestWorksField style={{ height: "fit-content" }}>
              ...
              <LatestWorksDescription>
                See some of my latest work! Let's enjoy! *Pss* <br /> If you
                want to see more, you need to visit{" "}
